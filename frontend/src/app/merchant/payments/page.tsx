...
export default function PaymentPagesPage() {
  ...
  useEffect(() => {
    ...
    socket.on('connect_error', (error) => {
      console.warn('Merchant Payments Socket connection error:', error);
    });
    ...
    socket.on('payment_update', (data) => {
      ...
      // For completed payments (PAYMENT_PAID), instantly update status to Success to trigger automated filter removal
